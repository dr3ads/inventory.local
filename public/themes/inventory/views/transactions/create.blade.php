    ...
    <div class="container-fluid">
        ...
        {!! Form::open(['route' => 'transactions.store', 'class' => 'form-horizontal', 'id' => 'create-transaction']) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">{!! Form::number('item_value',0,array('min' => 0, 'step' => 'any', 'class' => 'form-control', 'required' => 'required')) !!}</div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10"> {!! Form::select('customer_id',$customers,'',array('class' => 'form-control chosen validate[required]', 'required' => 'required', 'data-prompt-position' => 'inline')) !!}</div>
                        <!--<p class="help-block">description for future use</p>-->
            </div>
            <div class="form-group">
                {!! Form::label('pawn_amount','Item Value', array('class' => 'col-md-2')) !!}
                <div class="col-md-10">{!! Form::number('item_value',0,array('min' => 0, 'step' => 'any', 'class' => 'form-control', 'required' => 'required')) !!}</div>
            </div>
